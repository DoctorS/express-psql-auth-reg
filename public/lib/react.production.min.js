...
;(function(N, q) {
  ...
  function Q() {
    ...
    if ('function' === typeof n)
      if (((n = { callback: n, priorityLevel: a, expirationTime: b, next: null, previous: null }), null === c)) c = n.next = n.previous = n
      else {
        d = null
        a = c
        do {
  ...
  function T(a, b, d, g) {
    ...
    else if ((null === a || 'object' !== typeof a ? (h = null) : ((h = (ka && a[ka]) || a['@@iterator']), (h = 'function' === typeof h ? h : null)), 'function' === typeof h)) for (a = h.call(a), f = 0; !(c = a.next()).done; ) (c = c.value), (h = b + U(c, f++)), (e += T(c, h, d, g))
  ...
  r = {
    ...
    createContext: function(a, b) {
      void 0 === b && (b = null)
      a = { $$typeof: Ba, _calculateChangedBits: b, _currentValue: a, _currentValue2: a, _threadCount: 0, Provider: null, Consumer: null }
